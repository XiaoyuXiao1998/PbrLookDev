Shader "Hidden/BilateralBlur"
{
    SubShader
    {
        ...
        half4 frag(v2f i) : SV_Target
        {
            ...
            float4 col = _AOTex.Sample(sampler_AOTex, uv);
            float4 col0a = _AOTex.Sample(sampler_AOTex, uv0a);
            float4 col0b = _AOTex.Sample(sampler_AOTex, uv0b);
            float4 col1a = _AOTex.Sample(sampler_AOTex, uv1a);
            float4 col1b = _AOTex.Sample(sampler_AOTex, uv1b);
            float4 col2a = _AOTex.Sample(sampler_AOTex, uv2a);
            float4 col2b = _AOTex.Sample(sampler_AOTex, uv2a);
